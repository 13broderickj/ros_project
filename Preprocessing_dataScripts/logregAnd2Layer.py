...
for i in range(nSteps):
    ...
    if (i+1)%10000 == 0: # then perform validation
      totalAcc=0.0
      for j in range(1):
...
builder.save()'''
saver.save(sess,'/home/jasebroderick/Documents/MSThesis/model/robustNoise3NoInverseLONG.ckpt')#~/home/jasebroderick/Documents/MSThesis/model$ 
coord.request_stop()
coord.join(threads)

...
pcl::PointCloud<pcl::PointXYZ>::Ptr pclWorld_clr_ptr(new pcl::PointCloud<pcl::PointXYZ>); //transformedImage
...
pcl::io::PointCloudImageExtractorFromNormalField<pcl::PointXYZ> pcie;
// Set it up if not happy with the defaults
// Try to extract an image

  pcl::io::savePNGFile("filename.png", pclWorld_clr_ptr);
